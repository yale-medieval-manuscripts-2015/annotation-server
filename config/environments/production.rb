Annotest::Application.configure do
  ...
  config.annotation_server.url = 'http://annotations.example.org/'
  ...
  # Server
  config.cookie_domain = ".ydc2.yale.edu"

  # Email
  config.action_mailer.default_url_options = { :host => "desmm.ydc2.yale.edu" }
